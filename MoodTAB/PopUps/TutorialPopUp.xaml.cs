...
namespace MoodTAB.Popups
{
    public partial class TutorialPopup : Popup
    {
        public TutorialPopup()
        {
            ...
            {
                new() { Title = "Registra tus emociones", Description = "Descripción 1" , Imagen="mt.png"},
                new() { Title = "Responde cuestionarios", Description = "Descripción 2" , Imagen="mt.png"},
                new() { Title = "Revisa tus respuestas", Description = "Descripción 3" , Imagen="mt.png"},
                new() { Title = "Personaliza tus registros", Description = "Descripción 4", Imagen="mt.png" }
            };
        }
