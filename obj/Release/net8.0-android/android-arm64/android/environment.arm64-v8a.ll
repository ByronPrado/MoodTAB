...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670779, ; uint32_t jnienv_initialize_method_token (0x6001d3b)
	i32 100670778, ; uint32_t jnienv_registerjninatives_method_token (0x6001d3a)
...
@dso_cache = dso_local local_unnamed_addr global [532 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2524456011247553464, ; hash 0x2308ab5df9828bb8, from name: libaot-MoodTAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MoodTAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3510488443928048115, ; hash 0x30b7c2a3f071f1f3, from name: libaot-MoodTAB.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MoodTAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 107
	...
	%struct.DSOCacheEntry {
		i64 3907358859282404346, ; hash 0x3639ba2e3180d3fa, from name: aot-MoodTAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MoodTAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	...
	%struct.DSOCacheEntry {
		i64 13411282483939564357, ; hash 0xba1e725cf5a2db45, from name: MoodTAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MoodTAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
	...
	%struct.DSOCacheEntry {
		i64 15279489738448904356, ; hash 0xd40ba6f6817920a4, from name: aot-MoodTAB.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MoodTAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 441
	...
	%struct.DSOCacheEntry {
		i64 15892521493840500197, ; hash 0xdc8d9418b19f95e5, from name: MoodTAB.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MoodTAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 460
...
@.env.3 = private unnamed_addr constant [37 x i8] c"1855c42b-f220-4a8f-bb30-f675c0a07611\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.moodtab\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [22 x i8] c"libaot-MoodTAB.dll.so\00", align 1
